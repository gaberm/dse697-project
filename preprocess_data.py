...
def main():
    ...
    lectures = list(range(1, 29))
    lectures.remove(10) # lecture 10 was cancelled
    lectures.remove(22) # lecture 22 was cancelled
    video_files = [f"{video_dir}lecture-{lecture}.mp4" for lecture in lectures]
    ...
    overlap = 10 # seconds
    dates = ["2025-01-21", "2025-01-23", "2025-01-28", "2025-01-30", "2025-02-04", "2025-02-06", "2025-02-11", "2025-02-13", "2025-02-18", "2025-02-25", "2025-02-27", "2025-03-04", "2025-03-06", "2025-03-11", "2025-03-13", "2025-03-25", "2025-03-27", "2025-04-01", "2025-04-03", "2025-04-08", "2025-04-15", "2025-04-22", "2025-04-24", "2025-04-29", "2025-05-01", "2025-05-06"]
